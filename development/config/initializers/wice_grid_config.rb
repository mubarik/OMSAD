if defined?(Wice::Defaults)
  ...
  Wice::Defaults::SHOW_HIDE_FILTER_ICON = '/assets/icons/grid/page_white_find.png'


  # Icon to trigger filtering.
  Wice::Defaults::FILTER_ICON = '/assets/icons/grid/table_refresh.png'

  # Icon to reset the filter.
  Wice::Defaults::RESET_ICON = "/assets/icons/grid/table.png"

  # Icon to reset the filter.
  Wice::Defaults::TOGGLE_MULTI_SELECT_ICON = "/assets/icons/grid/expand.png"

  # CSV Export icon.
  Wice::Defaults::CSV_EXPORT_ICON = "/assets/icons/grid/page_white_excel.png"

  # Tick-All icon for the action column.
  Wice::Defaults::TICK_ALL_ICON = "/assets/icons/grid/tick_all.png"

  # Untick-All icon for the action column.
  Wice::Defaults::UNTICK_ALL_ICON = "/assets/icons/grid/untick_all.png"
  ...
  Wice::Defaults::DELETE_QUERY_ICON = '/assets/icons/grid/delete.png'
